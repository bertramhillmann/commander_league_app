...
export const COMMANDER_MMR_CONFIG = {
  ...
  tiers: [
    { tier: "god", minMMR: 2400, label: "God" },
    { tier: "legend", minMMR: 2200, label: "Legend" },
    { tier: "diamond", minMMR: 2000, label: "Diamond" },
    { tier: "platinum", minMMR: 1875, label: "Platinum" },
    { tier: "gold", minMMR: 1750, label: "Gold" },
    { tier: "silver", minMMR: 1600, label: "Silver" },
    { tier: "bronze", minMMR: 1300, label: "Bronze" },
